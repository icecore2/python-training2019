# http://lifemichael.com/moodle/mod/assign/view.php?id=13543
...
# Develop a separated module that uses the circle module and creates two objects for representing two
# circles. The first circle has the 5cm radius.
...
import archive.classes.modules
importedMath =
